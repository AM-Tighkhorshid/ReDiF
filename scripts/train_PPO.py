...
def main(_):
    ...
    ##############################################################################################################################
    ##############################################################################################################################
    # Use composite reward: clip + dino + text_image + aesthetic
    # reward_types = ["clip", "dino", "text_image", "aesthetic"]
    ...
    for epoch in range(config.num_epochs):
        ...
        if accelerator.is_main_process:
            eval_prompts = [
                "A cat on a chair",
                "A high-resolution photo of a futuristic cyberpunk city at night, neon lights reflecting on wet streets, ultra-detailed, 8k",
