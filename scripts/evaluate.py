...
parser.add_argument("--student_model", default="/media/external20/amirhossein_tighkhorshid/diffusion_distillation/ddpo-pytorch-main/ddpo-pytorch-main/PPO_clip_kl0.0_coco_batch_size_9_____third_try/student_model", help="Student model directory")
...
parser.add_argument("--batch_size", type=int, default=128, help="Batch size for metrics calculation") # batch size is added
