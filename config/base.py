...
def get_config():
    ...
    # add these to the `config` object in your base.py
    # Teacher-student training options
    config.teacher_model_id = "runwayml/stable-diffusion-v1-5"
    config.student_model_id = "runwayml/stable-diffusion-v1-5"
    config.encoder_type = "clip"  # Can be "clip" or "dino"
    config.use_kl_loss = False
    config.kl_weight = 0.1
    config.teacher_steps = 50
